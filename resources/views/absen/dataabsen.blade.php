                    ...
                    <div class="table-responsive">
                        <table id="mytable" class="table table-striped">
                            ...
                            <tr>
                                ...
                                {{-- <td>{{ $da->name }}</td> --}}
                                <td>{{ $da->karyawan->name ?? 'Unknown' }}</td>
                                <td>
                                    @if ($da->Shift)
                                ...
                                <td>
                                    ...
                                    @elseif($da->status_absen == 'Lepas')
                                        <span class="badge badge-info">Lepas</span>
                                    @elseif($da->status_absen == 'Cuti Tahunan')
                                        <span class="badge badge-warning">Sedang Cuti</span>
                                    @elseif($da->status_absen == 'Izin Sakit')
                                        <span class="badge badge-warning">Sedang Izin Sakit</span>
                                    @elseif($da->status_absen == 'Cuti Menikah')
                                        <span class="badge badge-warning">Sedang Cuti Menikah</span>
                                    @elseif($da->status_absen == 'Cuti Melahirkan')
                                        <span class="badge badge-warning">Sedang Melahirkan</span>
                                    @elseif($da->status_absen == 'Cuti Keguguran')
                                        <span class="badge badge-warning">Sedang Izin</span>
                                    @elseif($da->status_absen == 'Cuti Istri Melahirkan/Keguguran')
                                        <span class="badge badge-warning">Sedang Izin</span>
                                    @elseif($da->status_absen == 'Cuti Menikahkan Anak')
                                        <span class="badge badge-warning">Sedang Cuti Menikahkan Anak</span>
                                    @elseif($da->status_absen == 'Cuti Khitanan Anak')
                                        <span class="badge badge-warning">Sedang Izin</span>
                                    @elseif($da->status_absen == 'Cuti Membabtiskan Anak')
                                        <span class="badge badge-warning">Sedang Izin</span>
                                    @elseif($da->status_absen == 'Cuti Keluarga Meninggal Atap')
                                        <span class="badge badge-warning">Sedang Izin</span>
                                    @elseif($da->status_absen == 'Cuti Keluarga Meninggal')
                                        <span class="badge badge-warning">Sedang Izin</span>
                                    @elseif($da->status_absen == 'Cuti Ibadah Besar')
                                        <span class="badge badge-warning">Sedang Izin</span>
                                ...
                                <td>
                                    ...
                                    @else
                                        ...
                                        @endphp
                                        <a href="{{ url('/maps/'.$da->lat_absen.'/'.$da->long_absen.'/'.$da->Karyawan->id) }}" style="background-color: rgb(146, 146, 146)" class="btn btn-xs" target="_blank"><i class="fa fa-eye" class="me-2"></i> Lihat</a>
                                ...
                                <td>
                                    ...
                                    @else
                                        <?php
                                            ...
                                            $pulang_cepat = intval($pulang_cepat);
                                ...
                                <td>
                                    ...
                                    @else
                                        ...
                                        @endphp
                                        <a href="{{ url('/maps/'.$da->lat_pulang.'/'.$da->long_pulang.'/'.$da->Karyawan->id) }}" style="background-color: rgb(146, 146, 146)" class="btn btn-xs" target="_blank"><i class="fa fa-eye" class="me-2"></i> Lihat</a>
                                ...
                                <td>
                                    ...
                                    @elseif($da->status_absen == 'Lepas')
                                        <span class="badge badge-info">Lepas</span>
                                    @elseif($da->status_absen == 'Cuti Tahunan' || $da->status_absen == 'Izin Telat' || $da->status_absen == 'Izin Pulang Cepat' ||$da->status_absen == 'Izin Sakit' || $da->status_absen == 'Cuti Menikah' || $da->status_absen == 'Cuti Melahirkan'|| $da->status_absen == 'Cuti Keguguran' || $da->status_absen == 'Cuti Istri Melahirkan/Keguguran' || $da->status_absen == 'Cuti Menikahkan Anak'|| $da->status_absen == 'Cuti Mengkhitankan Anak'|| $da->status_absen == 'Cuti Membabtiskan Anak' || $da->status_absen == 'Cuti Keluarga Meninggal Atap' || $da->status_absen == 'Cuti Keluarga Meninggal' || $da->status_absen == 'Cuti Ibadah Besar')
