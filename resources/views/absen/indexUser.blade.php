...
@section('container')
    ...
    <div class="transfer-content">
        ...
        @elseif(in_array($shift_karyawan->status_absen, ["Cuti", "Cuti Ibadah Besar", "Cuti Menikah","Cuti Keguguran","Cuti Menikah","Cuti Istri Melahirkan","Cuti Menikahkan Anak","Cuti Mengkhitankan Anak","Cuti Membaptiskan Anak"]))
            <center>
                <h2>Hari Ini Anda Cuti</h2>
            </center>
        @elseif($shift_karyawan->status_absen == "Izin Sakit")
            <center>
                <h2>Hari Ini Anda Izin Sakit</h2>
            </center>
        @else
