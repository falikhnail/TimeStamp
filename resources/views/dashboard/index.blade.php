        ...
        <div class="col-xl-2 col-lg-4 col-sm-4 des-xsm-50 box-col-33">
          <div class="card investment-sec">
            ...
            <div class="card-body">
              ...
              <p>Alfa</p>
              <h3>{{ ($jumlah_user - ($jumlah_masuk + $jumlah_izin_telat + $jumlah_izin_pulang_cepat + $jumlah_libur + $jumlah_cuti + $jumlah_izin_masuk +  $jumlah_lepas + $jumlah_izin_sakit)) }}</h3>
            </div>
          </div>
        </div>
        <div class="col-xl-2 col-lg-4 col-sm-4 des-xsm-50 box-col-33">
        ...
        <div class="col-xl-2 col-lg-4 col-sm-4 des-xsm-50 box-col-33">
          <div class="card investment-sec">
            ...
            <div class="card-body">
              ...
              <p>Izin</p>
              <h3>{{ $jumlah_izin_masuk + $jumlah_izin_telat + $jumlah_izin_pulang_cepat + $jumlah_izin_sakit}}</h3>
            </div>
          </div>
        </div>
        <div class="col-xl-2 col-lg-4 col-sm-4 des-xsm-50 box-col-33">
        ...
        document.addEventListener("DOMContentLoaded", function () {
            ...
            var calendar = new FullCalendar.Calendar(calendarEl, {
                ...
                events: [
                  ...
                  @endforeach
                  @php
                    $data_cuti = App\Models\Cuti::select('karyawan_id', 'tanggal')->where('status_cuti', 'Diterima')->whereBetween('tanggal', [$tgl_mulai, $tgl_akhir])->get();
                  @endphp
