                ...
                <ul class="sidebar-links" id="simple-bar">
                  ...
                  <li class="menu-box"> 
                    <ul>
                        ...
                        <li class="sidebar-list">
                            <a class="sidebar-link sidebar-title link-nav" href="{{ url('/notifications') }}">
                        ...
                        <li class="sidebar-list">
                            <a class="sidebar-link sidebar-title link-nav" href="{{ url('/pegawai') }}">
                                <i data-feather="users"></i><span>Pegawai</span>
                            </a>
                        </li>
                        <li class="sidebar-list">
                            <a class="sidebar-link sidebar-title link-nav" href="{{ url('/shift') }}">
                                <i data-feather="git-pull-request"></i><span>Shift</span>
                            </a>
                        </li>
                        {{-- <li class="sidebar-list">
                            <a class="sidebar-link sidebar-title link-nav" href="{{ url('/auto-shift') }}">
                                <i data-feather="git-pull-request"></i><span>Auto Shift</span>
                            </a>
                        </li> --}}
                        <li class="sidebar-list">
                            <a class="sidebar-link sidebar-title link-nav" href="{{ url('/rekap-data') }}">
                                <i data-feather="credit-card"></i><span>Rekap Data</span>
                            </a>
                        </li>
                        <li class="sidebar-list">
                            <a class="sidebar-link sidebar-title link-nav" href="{{ url('/lokasi-kantor') }}">
                                <i data-feather="map-pin"></i><span>Lokasi</span>
                            </a>
                        </li>
                        <li class="sidebar-list">
                            <a class="sidebar-link sidebar-title link-nav" href="{{ url('/jabatan') }}">
                                <i data-feather="package"></i><span>Divisi</span>
                            </a>
                        </li>
                        ...
                        <li class="sidebar-list">
                            <a class="sidebar-link sidebar-title" href="javascript:void(0)">
                                <i data-feather="film"></i><span>Overtime</span>
                            </a>
                            <ul class="sidebar-submenu">
                        ...
                        <li class="sidebar-list">
                            <a class="sidebar-link sidebar-title" href="javascript:void(0)" >
                                <i data-feather="shuffle"></i><span>Cuti</span>
                            </a>
                            <ul class="sidebar-submenu">
                              <li><a href="{{ url('/data-cuti') }}">Data Cuti</a></li>
                              <li><a href="{{ url('/data-izin') }}">Data izin</a></li>
                              <li><a href="{{ url('/data-sakit') }}">Data Sakit</a></li>
                            </ul>
                        </li>
                        <li class="sidebar-list">
                            <a class="sidebar-link sidebar-title" href="javascript:void(0)">
                                <i data-feather="dollar-sign"></i><span>Keuangan</span>
                            </a>
                            <ul class="sidebar-submenu">
                        ...
                        <li class="sidebar-list">
                            <a class="sidebar-link sidebar-title link-nav {{ Request::is('dokumen*') ? 'active' : '' }}" href="{{ url('/dokumen') }}">
                                <i data-feather="folder"></i><span>Dokumen Pegawai</span>
                            </a>
                        </li>
                        <li class="sidebar-list">
                          <a class="sidebar-link sidebar-title link-nav" href="{{ url('/index-user') }}">
                              <i class="fa fa-user-plus"></i><span>User</span>
                          </a>
                      </li>
                        @endif
                
                        <!-- Menu khusus untuk admin_divisi -->
                        ...
                        <!-- Menu khusus untuk finance -->
                        @if (auth()->user()->is_admin == "finance")
                        <li class="sidebar-list">
                            <a class="sidebar-link sidebar-title link-nav" href="{{ url('/rekap-data') }}">
                                <i data-feather="credit-card"></i><span>Rekap Data</span>
                            </a>
